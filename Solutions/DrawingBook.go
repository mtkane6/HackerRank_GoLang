...
// PageCount returns the minimum number of page turns needed, either from the front or back of the book
func PageCount(n int32, p int32) int32 {
	var pages, pageTurns int32 = n / 2, p / 2
	if pageTurns <= pages/2 {
		return pageTurns
	}
	return pages - pageTurns
}
